...
Bundled [clef-keyservice](https://github.com/clef-sh/keyservice) binary for **macOS x64 (Intel)**.
...
a macOS x64 machine, npm automatically installs this package and Clef resolves the bundled
